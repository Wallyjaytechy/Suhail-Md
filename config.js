...
global.gurl  =process.env.GURL  || "https://wa.me/2348101194243";
global.website=process.env.GURL || "https://wa.me/2348101194243" ; 
...
global.caption = process.env.CAPTION || global.caption || "POWERED BY HOLAR MD" 


global.devs = "2348101194243" // Developer Contact
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "2348101194243";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2348101194243";
...
module.exports = {
  ...
  botname : process.env.BOT_NAME  || "HOLAR MD",
  ownername:process.env.OWNER_NAME|| "It's Holar",
  ...
  LANG: ( process.env.THEME ||  "HOLAR"  ).toUpperCase(),
